  ...
  config = lib.mkMerge [
    {
      ...
      home.username = lib.mkDefault "vika4ka";
      home.homeDirectory = lib.mkDefault "/home/vika4ka/";
    }
    #NOTE: Private informations per module

    #NOTE: hyprland
    (lib.mkIf config.programs.hyprpanel.enable {
      i18n.inputMethod.fcitx5.imList = ["keyboard-us" "keyboard-ua" "keyboard-ru" "mozc" "keyboard-de"];
      programs.hyprpanel.settings.menus.dashboard.powermenu.avatar.image = ./assets/vika4ka.jpg;
      programs.hyprlock.settings.image = [
        # USER AVATAR
        {
          path = "${./assets/vika4ka.jpg}";
          size = 200;
          position = "0, 250";
          halign = "center";
          valign = "center";
    ...
    (lib.mkIf config.programs.thunderbird.enable {
      accounts.email.accounts = {
        Victoria = {
          address = "victoria@mikilio.com";
          aliases = [];
          realName = "Victoria Suzdaleva";
          imap = {
          ...
          passwordCommand = "secret-tool lookup email victoria@mikilio.com";
          thunderbird.enable = true;
        };

        Google = {
          primary = true;
          address = "vsnape462@gmail.com";
          flavor = "gmail.com";
          realName = "Viktoriia Suzdalieva";
          thunderbird = {
            enable = true;
            settings = id: {
    ...
    (lib.mkIf config.programs.rbw.enable {
      programs.rbw.settings.email = "victoria@mikilio.com";
    })
